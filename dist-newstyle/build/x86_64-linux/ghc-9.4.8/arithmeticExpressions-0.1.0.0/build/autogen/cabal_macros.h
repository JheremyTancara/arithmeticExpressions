...
/* package arithmeticExpressions-0.1.0.0 */
#ifndef VERSION_arithmeticExpressions
#define VERSION_arithmeticExpressions "0.1.0.0"
#endif /* VERSION_arithmeticExpressions */
#ifndef MIN_VERSION_arithmeticExpressions
#define MIN_VERSION_arithmeticExpressions(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_arithmeticExpressions */
...
#define CURRENT_PACKAGE_KEY "arithmeticExpressions-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "arithmeticExpressions-0.1.0.0-inplace"
